        ...
        <>
            <div className="flex flex-col-reverse lg:flex-row justify-center lg:justify-around w-full items-center px-[25px] md:px-[50px] md:my-10">
                ...
                <div className="flex flex-col items-center lg:items-start lg:w-1/2">
                    <h1 className='text-[#4396A2] figtree-semibold text-4xl mt-6 md:mt-0 lg:text-7xl mb-6 relative after:absolute after:bottom-0 after:left-0 after:h-1 after:w-16 lg:after:w-32 after:bg-[#4396A2]'>ABOUT US</h1>
